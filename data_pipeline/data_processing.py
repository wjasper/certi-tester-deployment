...
def data_processing(file):
    ...
    resistance_time_plot_data = plot_graph.generate_plotly_figure(df,'Resistance (mm of H2O)', test_type=meta_data.get('test_type'))
    ...
    if meta_data.get('test_type') == "G":
     ...
     #Test is L or P test           
        ...
        penetration_time_plot_data = plot_graph.generate_plotly_figure(df,'Penetration (%)', test_type=meta_data.get('test_type'))
